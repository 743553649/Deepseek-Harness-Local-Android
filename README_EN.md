...
**Download a Release (recommended)**: grab the APK from [Releases](https://github.com/743553649/Deepseek-Harness-Local-Android/releases) (pick `arm64-v8a` for phones; latest is **v1.2.32**), then install with unknown sources allowed. Any v1.0.0+ build can be installed over the top.
