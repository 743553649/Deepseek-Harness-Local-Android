...
**下载 Release（推荐）**：前往 [Releases](https://github.com/743553649/Deepseek-Harness-Local-Android/releases) 下载 APK（手机选 `arm64-v8a`，最新版 **v1.2.30**），允许安装未知来源应用后安装。v1.0.0+ 均可覆盖安装。
